            ...
            <div class="container">
                <div class="row align-items-center justify-content-center extra-very-small-screen">
                    <div class="col-xl-8 col-lg-10 text-center position-relative page-title-extra-large" data-anime='{ "el": "childs", "translateY": [-15, 0], "opacity": [0,1], "duration": 300, "delay": 0, "staggervalue": 300, "easing": "easeOutQuad" }'>
                        ...
                        <h2 class="fw-400 ls-0px mb-0">Agency of Tailored Digital Solutions</h2>
                    </div>
                </div>
            </div>
        </section>
        ...
        <section>
            <div class="container">
                    ...
                    <div class="col-lg-5 md-mb-10px" data-anime='{ "translateY": [0, 0], "opacity": [0,1], "duration": 800, "delay": 200, "staggervalue": 300, "easing": "easeOutQuad" }'>
                        <div class="icon-with-text-style-08 mb-25px">
                            <div class="feature-box feature-box-left-icon-middle">
                                <div class="feature-box-icon feature-box-icon-rounded w-50px h-50px rounded-circle bg-base-color me-15px">
                                    <i class="bi bi-star-fill text-dark-gray"></i>
                                </div>
                                <div class="feature-box-content">
                                    <span class="d-inline-block fs-15 lh-24 fw-700 text-dark-gray text-uppercase text-decoration-line-bottom">5-STAR RATING DIGITAL AGENCY</span>
                                </div>
                            </div>
                        </div>
                        <h3 class="text-dark-gray fw-600 ls-minus-2px">We’re a trusted digital agency.</h3>
                    </div>
                    <div class="col-lg-7" data-anime='{ "el": "childs", "translateY": [15, 0], "opacity": [0,1], "duration": 300, "delay": 0, "staggervalue": 100, "easing": "easeOutQuad" }'>
                        <div class="row">
                            ...
                            <div class="col-md-9 last-paragraph-no-margin">
                                <p>Elevating businesses through technology-driven innovation, backed by solutions you can always trust.</p>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-9 last-paragraph-no-margin">
                                <p>Delivering customized, high-performance solutions that seamlessly integrate technology and business for lasting impact.</p>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="row row-cols-1 row-cols-lg-5 row-cols-md-3 row-cols-sm-2 clients-style-06 justify-content-center" data-anime='{ "translateY": [0, 0], "opacity": [0,1], "duration": 800, "delay": 200, "staggervalue": 300, "easing": "easeOutQuad" }'>
                    ...
                    <!-- start client item -->
                    <div class="col client-box text-center md-mb-40px">
                        <a href="#"><img src="images/companies/strategic-agenda-black.png" class="h-35px" alt="StrategicAgenda"></a>
                    </div>
                    <!-- end client item -->
                    <!-- start client item -->
                    <div class="col client-box text-center md-mb-40px">
                    ...
                    <div class="col client-box text-center sm-mb-40px">
                        <a href="#"><img src="images/companies/lanza-black.png" class="h-35px" alt="Lanza"></a>
                    </div>
                    <!-- end client item -->
                    <!-- start client item -->
                    ...
                    <!-- start client item -->
                    <div class="col client-box text-center">
                        <a href="#"><img src="images/companies/Praxis_Logo-black.png" class="h-35px" alt=""></a>
                    </div>
                    <!-- end client item -->
                </div>
            </div>
...
{{--                    <div class="col-11 position-relative h-750px md-h-600px sm-h-350px border-radius-6px border border-color-transparent position-relative" data-parallax-background-ratio="0.5" style="background-image: url('https://via.placeholder.com/1920x1100');">--}}
{{--                        <a href="https://www.youtube.com/watch?v=cfXHhfNy7tU" class="popup-youtube">--}}
{{--                            <div class="absolute-middle-center z-index-9">--}}
{{--                                <img src="images/demo-web-agency-05-white-v2.png" class="animation-rotation" alt="">--}}
{{--                                <div class="absolute-middle-center w-100 z-index-minus-1"><img src="images/demo-web-agency-about-02.png" alt=""></div>--}}
{{--                            </div>--}}
{{--                        </a>--}}
{{--                    </div>--}}
{{--                </div>--}}
            ...
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-5 md-mb-30px" data-anime='{ "el": "childs", "translateX": [15, 0], "opacity": [0,1], "duration": 600, "delay": 100, "staggervalue": 300, "easing": "easeOutQuad" }'>
                        ...
                        <h3 class="text-dark-gray fw-600 ls-minus-2px">Seamlessly integrating business goals into the digital ecosystem.</h3>
                        <p class="w-90 md-w-100">We take pride in our work, transforming ideas into impactful results for our clients.</p>
                        <a href="{{route('agency.expertise')}}" class="btn btn-large btn-expand-ltr text-dark-gray btn-rounded fw-700"><span class="bg-base-color"></span>See what we do</a>
                    </div>
                        ...
                        <div class="row row-cols-auto row-cols-sm-2" data-anime='{ "el": "childs", "translateX": [50, 0], "opacity": [0,1], "duration": 600, "delay":300, "staggervalue": 150, "easing": "easeOutQuad" }'>
                            ...
                            <div class="col align-self-start">
                                <div class="feature-box text-start ps-30px">
                                    ...
                                    <div class="feature-box-content last-paragraph-no-margin pt-25 md-pt-17 sm-pt-40px">
                                        ...
                                        <p>Shaping creative strategies that elevate your digital presence.</p>
                            ...
                            <div class="col align-self-end mt-20 xs-mt-15px">
                                <div class="feature-box text-start ps-30px">
                                    ...
                                    <div class="feature-box-content last-paragraph-no-margin pt-25 md-pt-17 sm-pt-40px">
                                        ...
                                        <p>Crafting visually stunning and user-focused web designs.</p>
                                        <span class="w-40px h-3px bg-base-color d-inline-block"></span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col align-self-start mt-minus-12 xs-mt-15px">
                                <div class="feature-box text-start ps-30px">
                                    ...
                                    <div class="feature-box-content last-paragraph-no-margin pt-25 md-pt-17 sm-pt-40px">
                                        <span class="text-dark-gray fs-19 d-inline-block fw-600 mb-5px">Great development</span>
                                        <p>Developing scalable and efficient web platforms tailored to your needs.</p>
                                        <span class="w-40px h-3px bg-base-color d-inline-block"></span>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="container">
                <div class="row mb-6 sm-mb-40px" data-anime='{"translateY": [0, 0], "opacity": [0,1], "duration": 800, "delay": 200, "staggervalue": 300, "easing": "easeOutQuad" }'>
                    <div class="col-lg-6 md-mb-25px">
                        <h3 class="mb-0 fw-600 text-dark-gray w-85 lg-w-100 ls-minus-2px">We believe in the power of collaboration and its ability to shape the future.</h3>
                    </div>
                    <div class="col-lg-5 offset-lg-1">
                        <p class="w-95 md-w-100">Our team is passionate about delivering solutions that empower businesses and drive innovation. With over 12 years of expertise, we consistently provide tailored, high-quality digital services that create lasting impact.</p>
...
{{--                                </div>--}}
{{--                                <div class="social-icon d-flex flex-column flex-shrink-1">--}}
{{--                                    <a href="https://www.linkedin.com/" target="_blank" class="text-dark-gray"><i class="fa-brands fa-linkedin-in icon-small"></i></a>--}}
{{--                                </div>--}}
{{--                            </figcaption>--}}
{{--                        </figure>--}}
{{--                    </div>--}}
...
{{--                                </div>--}}
{{--                                <div class="social-icon d-flex flex-column flex-shrink-1">--}}
{{--                                    <a href="https://www.behance.net/" target="_blank" class="text-dark-gray"><i class="fa-brands fa-behance icon-small"></i></a>--}}
{{--                                </div>--}}
{{--                            </figcaption>--}}
{{--                        </figure>--}}
{{--                    </div>--}}
...
{{--                                </div>--}}
{{--                                <div class="social-icon d-flex flex-column flex-shrink-1">--}}
{{--                                    <a href="https://www.facebook.com/" target="_blank" class="text-dark-gray"><i class="fa-brands fa-facebook-f icon-small"></i></a>--}}
{{--                                </div>--}}
{{--                            </figcaption>--}}
{{--                        </figure>--}}
{{--                    </div>--}}
...
{{--                </div>--}}
                <div class="row mb-2">
                    <div class="col-12 text-center">
                        <div class="text-dark-gray fs-20 ls-minus-05px">Our <span class="fw-700">dedicated team</span> is ready to collaborate with you. <a href="{{route('agency.contact')}}" class="text-dark-gray text-dark-gray-hover fw-600 text-decoration-line-bottom">Reach out to us today</a></div>
                    </div>
                </div>
            </div>
        </section>
