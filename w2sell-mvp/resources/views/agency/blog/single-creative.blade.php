...
{{--                        <span class="fs-18 mb-30px d-inline-block sm-mb-20px">By <a href="demo-web-agency-blog.html" class="text-dark-gray text-dark-gray-hover text-decoration-line-bottom">Jackson</a> in <a href="demo-web-agency-blog.html" class="text-dark-gray text-dark-gray-hover text-decoration-line-bottom">Marketing</a> on 26 November 2021</span>--}}
                        <h1 class="alt-font fw-600 text-dark-gray ls-minus-2px mb-0">{{$post->title}}</h1>
                    </div>
                </div>
            </div>
        </section>
        ...
        <section class="py-0 ps-13 pe-13 lg-ps-4 lg-pe-4 sm-px-0">
            <div class="container-fluid">
                <div class="row justify-content-center">
                    <div class="col-12"><img src="{{$post->image_url}}" class="w-100" alt=""></div>
                </div>
            </div>
        </section>
        <!-- end section -->
                                ...
                                <li class="grid-item design marketing">
                                    <div class="card bg-transparent border-0 h-100">
                                        ...
                                        <div class="card-body px-0 pt-30px pb-30px xs-pb-15px">
                                            ...
                                            <a href="{{route('agency.blog.post', $relatedPost->slug)}}" class="card-title fw-600 fs-17 lh-28 text-dark-gray text-dark-gray-hover d-inline-block w-95 sm-w-100">{{$relatedPost->title}}</a>
