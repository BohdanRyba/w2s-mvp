        ...
        <div class="container">
            <div class="row align-items-center justify-content-center extra-very-small-screen">
                <div class="col-xl-8 col-lg-10 text-center position-relative page-title-extra-large"
                    ...
                    <h1 class="fw-700 text-dark-gray mb-20px ls-minus-2px">Expertise</h1>
        ...
        <div class="container">
            <div class="row mb-6 mt-7 md-mb-50px">
                <div class="col-xl-5 col-lg-6"
                    ...
                    <h3 class="text-dark-gray fw-600 ls-minus-2px w-95 xl-w-100">Create a unique digital
                        experiences.</h3>
                    <p class="w-95 md-w-100">Lorem ipsum is simply dummy text of the printing and typesetting industry
                ...
                <div class="col-lg-6 offset-xl-1 progress-bar-style-01 mt-50px"
                    ...
                    <div class="progress mb-12 sm-mb-60px bg-extra-medium-gray">
                        ...
                        <div class="progress-bar bg-dark-gray" role="progressbar" aria-valuenow="80" aria-valuemin="0"
                            ...
                            <span class="progress-bar-percent text-center bg-dark-gray fs-11 fw-600 lh-12 text-white">80%</span>
                        </div>
                    </div>
